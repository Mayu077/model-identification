...
import { bigserial, boolean, check, date, integer, jsonb, pgTable, primaryKey, text, timestamp, unique } from "drizzle-orm/pg-core"
...
// role is constrained to 'owner' only. Driver accounts (Phase 4 Tier 2) require
// widening memberships_role_check before a non-owner membership can be created.
